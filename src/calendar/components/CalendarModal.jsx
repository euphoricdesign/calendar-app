...
registerLocale('en', en) // react-datepicker utiliza la biblioteca date-fns para el manejo y formato de fechas, y registerLocale se utiliza para registrar localizaciones adicionales proporcionadas por date-fns/locale.
...
export const CalendarModal = () => {
    ...
    return (
        <Modal
            ...
            closeTimeoutMS={ 200 }
        >
            <h1 className='tw-text-[20px] tw-mb-[18px]'> Create a new event </h1>
            <form onSubmit={ onSubmit }>
                <div className="form-group mb-2">
                    <label className='tw-text-gray-500'>Start date and time</label>
                    <DatePicker 
                ...
                <hr />
                <div className="form-group mb-2">
                    <label className='tw-text-gray-500'>Title and notes</label>
                    <input 
                        type="text" 
                    ...
                    />
                    <small className="form-text text-muted">Short description</small>
                </div>
